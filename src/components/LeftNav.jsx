  ...
  return (
    <nav className={`left-nav${isOverlay ? ' left-nav--overlay' : ''}`}>
      ...
      <Box className="left-nav__header" sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', p: '12px 12px 12px 16px' }}>
        <Box className="left-nav__brand" sx={{ display: 'flex', alignItems: 'center' }}>
          <img src="/logo-dark.svg" alt="Planner" height={28} />
        </Box>
      ...
      <Box className="left-nav__body" sx={{ flex: 1, overflowY: 'auto', px: 0 }}>
        ...
        {hasFavorites && (
          <Box className="left-nav__section" sx={{ mb: 1.5 }}>
            <Typography variant="subtitle2" color="text.secondary" className="left-nav__section-label" sx={{ px: 1.5, py: 0.5, fontWeight: 400 }}>
              Favourites
            </Typography>
        ...
        <Box className="left-nav__section">
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', px: 1.5, py: 0.5 }}>
            <Typography variant="subtitle2" color="text.secondary" className="left-nav__section-label" sx={{ fontWeight: 400 }}>Boards</Typography>
